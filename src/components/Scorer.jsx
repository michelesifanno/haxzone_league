...
export default function Scorer() {
    ...
    const bestScorerData = playerStats.reduce((prev, current) => (prev.stats.goals > current.stats.goals) ? prev : current);
    const bestScorer = players.find((player) => player.name === bestScorerData.name);

    const bestScorerTeam = teams.find((team) => team.name === bestScorer.team.name);
    ...
    const filteredPlayerStats = playerStats.filter(player => player.name !== bestScorer.name);
            ...
            <Grid container spacing={2} justifyContent="flex-start" alignItems="center">
                <Grid item xs={12} alignItems="center">
                    ...
                    <Typography variant="p" component="p" color={theme.palette.text.primary}>
                        Di seguito, la classifica Marcatori... Finora!
                    </Typography>
                </Grid>
            </Grid>
